    ...
    while (layer != NULL) {
        ...
        switch (layer->type) {
            ...
            case LAYER_TYPE_CONV: {
                ...
                printf("l_shift: %d r_shift:%d k_size: %d k_stride: %d k_padding: %d\n",
            ...
            case LAYER_TYPE_POOL: {
                ...
                printf("k_size: %d k_stride: %d k_padding: %d\n",
    ...
    while (layer != NULL) {
        ...
        switch (layer->type) {
            ...
            case LAYER_TYPE_CONV: {
                ...
                if (conv_func) {
                    printf("forward: %s(%s, %d, %d, %s, %d, %d, %d, %d, %s, %d, %d, %s, %d, %s, %p);\n",
                            ...
                            BUFFER_2STR(output_buffer), conv_layer->h, "col_buffer", (void*)NULL);
                } else {
                    printf("forward: %s(%s, %d, %d, %d, %s, %d, %d, %d, %d, %d, %d, %d, %s, %d, %d, \
                        %s, %d, %d, %s, %p);\n",
                            ...
                            BUFFER_2STR(output_buffer), conv_layer->w, conv_layer->h, "col_buffer", (void*)NULL);
                }
                break;
            }
            ...
            case LAYER_TYPE_RELU: {
                relu_layer_t *relu_layer = (relu_layer_t *) layer;
                printf("forward: arm_relu_q7(%s, %d*%d*%d);\n",
            ...
            case LAYER_TYPE_POOL: {
                ...
                if (pool_func) {
                    printf("forward: %s(%s, %d, %d, %d, %d, %d, %d, %s, %s);\n",
                    ...
                    printf("forward: %s(%s, %d, %d, %d, %d, %d, %d, %d, %d, %s, %s);\n",
            ...
            case LAYER_TYPE_IP: {
                ip_layer_t *ip_layer = (ip_layer_t*) layer;
                printf("forward: arm_fully_connected_q7_opt(%s, %s, %d, %d, %d, %d, %s, %s, %s);\n",
