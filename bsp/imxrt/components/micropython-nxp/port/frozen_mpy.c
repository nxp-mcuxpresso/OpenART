...
enum {
    MP_QSTRfrozentest_dot_py = MP_QSTRnumber_of,
    MP_QSTRuPy,
    MP_QSTRi,
};
...
STATIC const byte fun_data_frozentest__lt_module_gt_[85] = {
    ...
    MP_QSTRfrozentest_dot_py & 0xff, MP_QSTR_frozentest_dot_py >> 8,
    0x29, 0x28, 0x28, 0x28, 0x2b, 0x28, 0x00,
    0x11, MP_QSTR_print & 0xff, MP_QSTR_print >> 8, 
    0x10, MP_QSTRuPy & 0xff, MP_QSTR_uPy >> 8, 
    0x34, 0x01, 
    0x59, 
    0x11, MP_QSTR_print & 0xff, MP_QSTR_print >> 8, 
    0x23, 0x00, 
    ...
    0x42, 0x0f, 0x80, 
    0x57, 
    0x16, MP_QSTRi & 0xff, MP_QSTRi >> 8, 
    0x11, MP_QSTR_print & 0xff, MP_QSTR_print >> 8, 
    0x11, MP_QSTRi & 0xff, MP_QSTRi >> 8, 
    0x34, 0x01, 
    0x59, 
    0x81, 
    0xe5, 
...
const mp_raw_code_t raw_code_frozentest__lt_module_gt_ = {
    ...
    .prelude = {
        ...
        .qstr_source_file = MP_QSTRfrozentest_dot_py,
