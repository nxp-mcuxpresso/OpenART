...
#warning "need to update to v1.14.0 to find the mp_obj_cast_to_native_base and MP_ERROR_TEXT"
...
STATIC mp_obj_t mp_funcptr_custom_zlib(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *arg2 = (const unsigned char *)mp_to_ptr(mp_args[2]);
...
STATIC mp_obj_t mp_lodepng_decode_memory(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *in = (const unsigned char *)mp_to_ptr(mp_args[3]);
...
STATIC mp_obj_t mp_lodepng_set_icc(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *profile = (const unsigned char *)mp_to_ptr(mp_args[2]);
...
{
    unsigned char *out = mp_to_ptr(mp_args[0]);
    const unsigned char *in = (const unsigned char *)mp_to_ptr(mp_args[1]);
...
STATIC mp_obj_t mp_lodepng_decode(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *in = (const unsigned char *)mp_to_ptr(mp_args[4]);
...
STATIC mp_obj_t mp_lodepng_inspect_chunk(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *in = (const unsigned char *)mp_to_ptr(mp_args[2]);
...
{
    const unsigned char *chunk = (const unsigned char *)mp_to_ptr(mp_args[0]);
...
STATIC mp_obj_t mp_lodepng_chunk_type(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *chunk = (const unsigned char *)mp_to_ptr(mp_args[1]);
...
{
    unsigned char *chunk = mp_to_ptr(mp_args[0]);
    unsigned char *end = mp_to_ptr(mp_args[1]);
...
{
    const unsigned char *chunk = (const unsigned char *)mp_to_ptr(mp_args[0]);
    const unsigned char *end = (const unsigned char *)mp_to_ptr(mp_args[1]);
...
STATIC mp_obj_t mp_lodepng_chunk_append(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *chunk = (const unsigned char *)mp_to_ptr(mp_args[2]);
...
STATIC mp_obj_t mp_lodepng_chunk_create(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    const unsigned char *data = (const unsigned char *)mp_to_ptr(mp_args[4]);
...
{
    const unsigned char *buf = (const unsigned char *)mp_to_ptr(mp_args[0]);
