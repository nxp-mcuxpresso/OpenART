    ...
    /*Draw the object*/
        ...
        for(row = 0; row < ext->row_cnt; row++) {
            ...
            for(col = 0; col < ext->col_cnt; col++) {
                ...
                if (cell_type >= LV_TABLE_CELL_STYLE_CNT)
...
static void refr_size(lv_obj_t * table)
{
    ...
    lv_style_int_t cell_left[LV_TABLE_CELL_STYLE_CNT]={0};
    lv_style_int_t cell_right[LV_TABLE_CELL_STYLE_CNT]={0};
    lv_style_int_t cell_top[LV_TABLE_CELL_STYLE_CNT]={0};
    lv_style_int_t cell_bottom[LV_TABLE_CELL_STYLE_CNT]={0};
    lv_style_int_t letter_space[LV_TABLE_CELL_STYLE_CNT]={0};
    lv_style_int_t line_space[LV_TABLE_CELL_STYLE_CNT]={0};
    const lv_font_t * font[LV_TABLE_CELL_STYLE_CNT]={0};
