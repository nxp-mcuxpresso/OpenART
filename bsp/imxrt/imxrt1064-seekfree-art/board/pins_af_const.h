    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF1_LPSPI4),  MP_OBJ_NEW_SMALL_INT(GPIO_AF1_LPSPI4) },
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF1_TMR1),    MP_OBJ_NEW_SMALL_INT(GPIO_AF1_TMR1) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF1_TMR2),    MP_OBJ_NEW_SMALL_INT(GPIO_AF1_TMR2) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF1_TMR3),    MP_OBJ_NEW_SMALL_INT(GPIO_AF1_TMR3) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF1_TMR4),    MP_OBJ_NEW_SMALL_INT(GPIO_AF1_TMR4) },
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF2_PWM2),    MP_OBJ_NEW_SMALL_INT(GPIO_AF2_PWM2) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF3_LPI2C1),  MP_OBJ_NEW_SMALL_INT(GPIO_AF3_LPI2C1) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_AF3_LPSPI4),  MP_OBJ_NEW_SMALL_INT(GPIO_AF3_LPSPI4) },
