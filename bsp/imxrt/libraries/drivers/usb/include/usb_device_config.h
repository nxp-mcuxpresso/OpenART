...
#ifndef USB_DEVICE_CDC_COUNT
#define USB_DEVICE_CDC_COUNT (1U)
#endif
#define USB_DEVICE_CONFIG_CDC_ACM (USB_DEVICE_CDC_COUNT)
...
#define OSA_ENTER_CRITICAL  rt_enter_critical
/*! @brief rt-thread port exit critical */
#define OSA_EXIT_CRITICAL   rt_exit_critical
