...
static int32_t ENET_CommonPowerControl(ARM_POWER_STATE state, cmsis_enet_mac_driver_state_t *enet)
{
    ...
    switch (state)
    {
        ...
        case ARM_POWER_FULL:
        {
            ...
            if (capabilities.media_interface == ARM_ETH_INTERFACE_MII)
            {
                config.miiMode = kENET_MiiMode;
            }
            else if (capabilities.media_interface == ARM_ETH_INTERFACE_RMII)
            {
...
cmsis_enet_mac_resource_t ENET0_Resource = {ENET_1G, ENET0_GetFreq};
#elif defined(ENET)
cmsis_enet_mac_resource_t ENET0_Resource = {ENET, ENET0_GetFreq};
#elif defined(ENET0)
cmsis_enet_mac_resource_t ENET0_Resource = {ENET0, ENET0_GetFreq};
#elif defined(ENET1)
cmsis_enet_mac_resource_t ENET0_Resource = {ENET1, ENET0_GetFreq};
#else
cmsis_enet_mac_resource_t ENET0_Resource = {CONNECTIVITY__ENET0, ENET0_GetFreq};
#endif
