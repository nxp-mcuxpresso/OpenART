...
/*! @name Driver version */
/*@{*/
/*! @brief Key Manager driver version. Version 2.0.0.
 *
 ...
 *   - Initial version
 */
#define FSL_KEYMGR_DRIVER_VERSION (MAKE_VERSION(2, 0, 0))
/*@}*/
...
typedef struct _domain_slot_config
{
    ...
    keymgr_lock_t domainLock;      /*!< Lock domain ID of slot. */
    uint8_t domainMapID;           /*!< Domain ID map of the slot to be locked. */
