...
#define FSL_XRDC2_DRIVER_VERSION (MAKE_VERSION(2, 0, 0))

/* Definitions for XRDC2 Exclusive access lock. */
#define XRDC2_EAL_FORCE_RELEASE_MAGIC_0 0x02000046U
#define XRDC2_EAL_FORCE_RELEASE_MAGIC_1 0x02000052U

#define XRDC2_EAL_DISABLE             (0U << XRDC2_MSC_MSAC_W1_EAL_SHIFT)
#define XRDC2_EAL_DISABLE_UNTIL_RESET (1U << XRDC2_MSC_MSAC_W1_EAL_SHIFT)
#define XRDC2_EAL_UNLOCKED            (2U << XRDC2_MSC_MSAC_W1_EAL_SHIFT)
#define XRDC2_EAL_LOCKED              (3U << XRDC2_MSC_MSAC_W1_EAL_SHIFT)
